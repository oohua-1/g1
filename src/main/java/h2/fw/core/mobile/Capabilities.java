...
public class Capabilities {
    private static final Logger LOGGER = LogManager.getLogger(Capabilities.class.getName());

    private static Capabilities instance;
    private JSONObject capabilities;
    private final H2Environment h2Environment;

    private Capabilities() {
        h2Environment = new H2Environment();
...
//                + "capabilities.json";
    ...
    private String getPlatform() {
        String platform = h2Environment.get("MOBILE_OS");
        String schema = null;
    ...
    private void isPlatformInEnv() {
        if (h2Environment.get("MOBILE_OS") == null) {
            throw new IllegalArgumentException("Please execute with Mobile OS (android, ios, flutter)");
        }
    }
}