...
import static h2.fw.core.mobile.ConfigFileManager.*;
import static h2.fw.core.mobile.FileLocations.PARALLEL_XML_LOCATION;
import static java.lang.System.getProperty;
import static java.util.Collections.addAll;
import static org.apache.commons.lang3.StringUtils.isNotEmpty;

public class H2Executor {
    ...
    public H2Executor(List<Device> deviceList) {
    ...
    public XmlSuite constructXmlSuiteForParallelRunner(List<String> tests,
        ...
        for (int i = 0; i < deviceCount; i++) {
            ...
            test.addParameter("device", device.getUdid());
            test.addParameter("hostName", device.getHost());
